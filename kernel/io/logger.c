 ...
 *
 * @file logger.c
 * @brief Implementation of logger.c
...
static void
print_int(pstream_t *ps, int64_t n, int32_t base, strprops_t props)
{
...
static void
print_unsigned(pstream_t *ps, uint64_t n, int32_t base, strprops_t props)
{
...
static int32_t
logger_impl(const char *color, const char *fmt, va_list va)
{
...
static int32_t
try_logger_impl(const char *color, uint64_t *missed_counter, const char *fmt, va_list va)
{
...
is_module_debug_enabled(uint32_t module_id)
{
