 ...
 *
 * @file vcpu.h
 * @brief Implementation of vcpu.h
...
extern void
set_stage2_pgd(unsigned long, unsigned long);
extern void
restore_sysregs(cpu_sysregs_t *);
extern void
save_sysregs(cpu_sysregs_t *);
extern void
get_all_sysregs(cpu_sysregs_t *);
extern void
save_cpu_ctx(trap_frame_t *);

int32_t
get_vcpuid(tcb_t *task);
list_t *
get_vcpus(tcb_t *task);  // if task==NULL, return current vm's vcpus
