 ...
 */
static inline uint8_t fat32_utils_is_path_separator(char c) {
    return (c == '/' || c == '\\');
}
 ...
 * @return char 大写字符
 */
static inline char fat32_utils_to_upper(char c) {
 ...
 * @return char 小写字符
 */
static inline char fat32_utils_to_lower(char c) {
    return (c >= 'A' && c <= 'Z') ? (c - 'A' + 'a') : c;
}
 ...
 */
static inline uint8_t fat32_utils_is_alnum(char c) {
 ...
 */
static inline uint32_t fat32_utils_align_up(uint32_t value, uint32_t alignment) {
 ...
 * @return uint32_t 对齐后的值
 */
static inline uint32_t fat32_utils_align_down(uint32_t value, uint32_t alignment) {
