...
#define HCR_VALUE_NO_ROUTE                                                                         \
    (HCR_TACR | HCR_TID3 | HCR_TID1 | HCR_TWE | HCR_TWI | HCR_E2H | HCR_RW | HCR_TGE | HCR_SWIO |  \
     HCR_VM)
#define HCR_VALUE_ROUTE                                                                            \
    (HCR_TACR | HCR_TSC | HCR_TWE | HCR_E2H | HCR_RW | HCR_TGE | HCR_AMO | HCR_IMO | HCR_FMO |     \
     HCR_SWIO | HCR_VM)
...
#define SCTLR_EL1_nTLSMD                                                                           \
    BIT(28) /* 不陷入对 Device-nGRE/Device-nGnRE/Device-nGnRnE 内存的 Load Multiple 和 Store Multiple 操作 */
...
#define SCTLR_EL1_UMA                                                                              \
    BIT(9) /* 用户屏蔽访问：将 EL0 执行访问 PSTATE.{D, A, I, F} 的 MSR/MRS 指令陷入到 EL1 */
