...
extern uint32_t get_debug_module(void);
extern int32_t logger_module_debug(uint32_t module_id, const char *fmt, ...);
extern int32_t try_logger_module_debug(uint32_t module_id, const char *fmt, ...);
