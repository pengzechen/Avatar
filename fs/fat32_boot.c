 ...
 *
 * @file fat32_boot.c
 * @brief Implementation of fat32_boot.c
...
fat32_boot_calculate_layout(const fat32_boot_sector_t *boot_sector, fat32_fs_info_t *fs_info)
{
    ...
    fs_info->data_start_sector =
        boot_sector->reserved_sectors + boot_sector->num_fats * boot_sector->fat_size_32;
    ...
    logger("FAT32: Layout calculated - FAT starts at sector %u, data starts at sector %u, %u "
           "clusters\n",
...
fat32_boot_print_info(const fat32_boot_sector_t *boot_sector)
{
    ...
    logger("Total sectors: %u\n",
           boot_sector->total_sectors_32 ? boot_sector->total_sectors_32
